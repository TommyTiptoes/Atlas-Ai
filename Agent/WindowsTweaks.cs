    ...
    public static class WindowsTweaks
    {
        ...
        public static async Task<string> DisableScreenshotNotifications()
        {
            try
            {
                ...
                // FIRST: Disable Atlas's own screenshot notifications
                ChatWindow.DisableScreenshotNotifications = true;
        ...
        public static async Task<string> EnableScreenshotNotifications()
        {
            try
            {
                // Re-enable Atlas's screenshot notifications
                ChatWindow.DisableScreenshotNotifications = false;
