...
namespace MinimalApp.Tools
{
    public static class ToolExecutor
    {
        ...
        public static async Task<string?> TryExecuteToolAsync(string userMessage)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[ToolExecutor] 🔧 Disabling screenshot notifications");
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[ToolExecutor] 🔧 Enabling screenshot notifications");
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[ToolExecutor] 🔧 Disabling Game Bar");
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[ToolExecutor] 🔧 Disabling Windows tips");
